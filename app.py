...
EXAMPLE_SENTENCES = [
    ...
    {
        "voice": "af_sarah",
        "text": "But first, we've got a special guest with us. Please welcome Nicole!",
    },
    {
        "voice": "af_sarah",
        "text": "Now, we've been told Nicole has a very unique way of speaking today... a bit of a mysterious vibe, if you will.",
    },
    {
        "voice": "af_nicole",
        "text": "Hey there... I'm so excited to be a guest today... But I thought I'd keep it quiet... for now...",
    },
    {
        "voice": "am_michael",
        "text": "Well, it certainly adds some intrigue! Let's dive in and see what that's all about.",
    },
    {
        "voice": "af_sarah",
        "text": "Today, we're covering something that's close to our hearts",
    },
...
def create_ui():
    ...
    with gr.Blocks(title="TTS") as interface:
